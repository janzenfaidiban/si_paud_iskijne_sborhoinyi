...
<body class="text-center">
    ...
    <div class="container">
        <main class="col-lg-6 mx-auto">
            <img src="./assets/img/welcome-img-1.png" alt="Logo PAUD" class="img img-fluid py-lg-5">
            <p class="fs-2">Selamat datang di <b>Sistem Informasi PAUD I.S Kijne Sborhoinyi.</b> </p>
