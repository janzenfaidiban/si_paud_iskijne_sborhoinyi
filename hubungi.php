...
<body class="text-center">
    ...
    <div class="container py-5">
        <main class="col-6 mx-auto">
            <h1 class="fw-bold mb-5">Hubungi Kami</h1>
            <p class="text-muted mb-4 col-lg-6 mx-auto">Sekolah kami bertempat di Kotaraja, Kota Jayapura, Papua. Berikut alamat lengkap dan nomor yang bisa dihubungi.</p>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>Jln.Sborhoinyi lembah furia kotaraja dalam – Kotaraja Kelurahan Wahno-Kecamatan Abepura-Kota Jayapura Papua-Kode</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">Pos </td>
                            <td>99325</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">Telp </td>
                            <td>0967-581159</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">Email </td>
                            <td>info@paudsborhoinyi.sch.id</td>
                        </tr>
                    </tbody>
                </table>
            </div>
