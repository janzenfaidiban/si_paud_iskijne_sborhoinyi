...
<body class="text-center">
    ...
    <div class="container py-5">
        <main class="col-lg-6 mx-auto">
            ...
            <p class="text-muted">Kami adalah Lembaga Pendidikan Non Formal yang saat ini berfokus pada pengembangan sumber daya manusia sejak dini. Lembaga kami telah ada sejak tahun 2012.</p>
            <p class="text-muted mb-3 fw-bold">Berikut detail rincian tentang lembaga yang kami dirikan:</p>

            <div class="table-responsive bg-white p-3 rounded shadow text-start">
                <table class="table">
                    <tbody>
                        <tr>
                            <td class="text-end fw-bold">Nama Lembaga </td>
                            <td>PAUD I.S. KIJNE SBORHOINYI</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">Alamat </td>
                            <td>Jl. Sborhoinyi RT.05/RW.05 wahno Distrik Abepura</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">Berdiri(Tgl/Bln/Thn) </td>
                            <td>30 Juli 2012</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">Nama Pengelola </td>
                            <td>August Ap</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">No/Tanggal Akta Notaris </td>
                            <td>81/29 Februari 2012</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">NPWP </td>
                            <td>03.225.192.8952.000</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">No/Tanggal Izin Operasional </td>
                            <td>421/146/2012, Tgl 7 Januari 2012</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">No Registrasi </td>
                            <td>90880268</td>
                        </tr>
                        <tr>
                            <td class="text-end fw-bold">NPSN </td>
                            <td>69953960</td>
                        </tr>
                    </tbody>
                </table>
