            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2 fw-bold">Detail Guru</h1>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="#">
                                    ...
                                    <div class="mb-3">
                                        <a href="?page=guru&action=ubah&id=<?php echo $rows['id']; ?>" class="btn btn-dark">
