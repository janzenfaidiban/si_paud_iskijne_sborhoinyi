            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2 fw-bold">Detail Surat Keluar</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p class="fs-6"><?php echo $rows['tujuan']; ?></p>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <a href="?page=surat-keluar&action=ubah&id=<?php echo $rows['id']; ?>" class="btn btn-dark">
