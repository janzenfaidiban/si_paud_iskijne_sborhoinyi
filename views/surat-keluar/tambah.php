<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 fw-bold">Tambah Surat Keluar</h1>
                ...
                <div class="card-body">
                    ...
                    <form action="./process/surat-keluar/tambah.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" disabled class="form-control" id="jenis_surat" name="jenis_surat" value="Keluar" placeholder="Tanggal Diterima...">
                        </div>
