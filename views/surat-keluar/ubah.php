<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 fw-bold">Ubah Surat Keluar</h1>

        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="?page=surat-keluar" class="btn btn-sm btn-outline-dark">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="./process/surat-keluar/ubah.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" disabled class="form-control" id="jenis_surat" name="jenis_surat" value="Keluar" value="<?php echo $rows['jenis_surat']; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="tujuan" class="form-label text-muted">Tujuan Surat</label>
                                    <input type="text" class="form-control" id="tujuan" name="tujuan" value="<?php echo $rows['tujuan']; ?>">
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <a href="?page=surat-keluar" class="btn btn-outline-dark">
